...
# Тут вся робота була повʼязана із пошуком оптимальних значень.
# Трохи часу зайняла ще налаштування камери для відображення.

# DY_CORRECT = -7.2 знайшов через ORB feature matching. Знайшов спільні точно на обох знімках.
# Проблема тут була в тому, що коли зсував телефон на 7 см,
# то на другому знімку камера опустила трохи, приблизно на 0.5 мм, через це отримав зсув по вертикалі.
#
# BASELINE_PX = 112.0, теж знайшов через ORB matching
#
# FOCAL_FULL - це теоретичний розрахунок для камери iPhone. Знайшов це інтернеті значення,
# тут важливі параметри для рохрахунку це 3.7мм і 6.4мм, вони йдуть з тех характеристик камери.
# Їх можна теж крутити, і можна отримати кращу якість.
#
# TARGET_W - зменшив роздільність з 3024px до 900px щоб швидше працювало.
#
# num_disp, block трохи підкрутив дефолті значення.
